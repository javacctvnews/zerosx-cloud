...
import com.zerosx.system.mapper.ISysDictTypeMapper;
...
public class SysDictTypeServiceImpl extends ServiceImpl<ISysDictTypeMapper, SysDictType> implements ISysDictTypeService {
    ...
    public boolean saveDictType(SysDictTypeDTO sysDictTypeDTO) {
        ...
        SysDictType dictType = BeanCopierUtil.copyProperties(sysDictTypeDTO, SysDictType.class);
        return save(dictType);
    }

    @Override
    public boolean updateSysDictType(SysDictTypeUpdateDTO sysDictType) {
        SysDictType dictType = BeanCopierUtil.copyProperties(sysDictType, SysDictType.class);
    ...
    public List<SysDictTypeVO> selectByMap(SysDictTypeRetrieveDTO sysDictType) {
        ...
        return BeanCopierUtil.copyPropertiesOfList(list, SysDictTypeVO.class);
    }

    @Override
    public SysDictTypeVO getDictTypeById(Long dictId) {
        SysDictType dictType = getById(dictId);
        return BeanCopierUtil.copyProperties(dictType, SysDictTypeVO.class);
    }
}
