...
public class CaptchaAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        CaptchaAuthenticationToken customAuthentication = (CaptchaAuthenticationToken) authentication;
        ...
        /*try {*/
            ...
            DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
                    ...
                    .authorizationGrantType(CustomAuthorizationGrantType.CAPTCHA_PWD)
    ...
    public void checkClient(RegisteredClient registeredClient) {
        ...
        if (!registeredClient.getAuthorizationGrantTypes().contains(CustomAuthorizationGrantType.CAPTCHA_PWD)) {
